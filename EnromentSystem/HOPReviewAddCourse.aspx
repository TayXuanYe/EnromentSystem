        ...
        <div class="container">
            ...
            <asp:GridView ID="gvRequests" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="btnAccept" runat="server" Text="Accept" CommandName="Accept" CommandArgument="<%# Container.DataItemIndex %>" CssClass="action-button" />
                            <asp:Button ID="btnNotAccept" runat="server" Text="Not Accept" CommandName="NotAccept" CommandArgument="<%# Container.DataItemIndex %>" CssClass="action-button" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
