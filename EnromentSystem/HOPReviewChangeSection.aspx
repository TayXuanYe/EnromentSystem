<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HOPReviewChangeSection.aspx.cs" Inherits="HOPReviewChangeSection" %>
        ...
        <div class="container">
            ...
            <asp:GridView ID="gvRequests" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="current_section_id" 
                        HeaderText="Current Section ID" 
                        SortExpression="current_section_id" />
                    <asp:BoundField DataField="target_section_id" 
                        HeaderText="Target Section ID" 
                        SortExpression="target_section_id" />
